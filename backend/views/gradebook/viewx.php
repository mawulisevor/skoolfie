...
<?= Html::a('Print PDF', ['printviewx' ,'id'=>$_GET['id']], ['class' => 'btn btn-success']) ?>
...
<div class="results-slip">
    ...
    <?php //!$sem1Provider === null
        if ($sem1Provider->models) {
        # Let results proceed
            echo "
            <table height='80' width='100%' border='0' padding='5' align='center'>
                <tr>
                    <th>Name:</th>
    ...
    <?php 
            //echo '<b>Index No: </b>'. Yii::$app->request->get('id') . '<br />';
            //echo json_encode($studProvider->getKeys()) . '<br />';
    ?>
    ...
    <?php 
        ...
        else{ echo 'No results for Semster 1 <br />';}
    ...
    <?php 
        ...
        else{ echo 'No results for Semster 2 <br />';} 
    ?>
    ...
    <?php 
        ...
        else{ echo 'No results for Semster 3 <br />';}
    ?>
    ...
    <?php 
        ...
        else{ echo 'No results for Semster 4 <br />';}
    ?>
    ...
    <?php 
        ...
        } else{ echo 'No results for Semster 5 <br />';}
    ?>
    ...
    <?php 
        ...
        } else{ echo 'No results for Semster 6 <br />';}
    ?>
